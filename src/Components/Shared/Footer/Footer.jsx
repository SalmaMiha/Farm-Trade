import logo from "../../../assets/Farm Trade.png";
        ...
        <div className="container pl-10 flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
          <div className="lg:w-1/3">
            ...
            >
              <div className="flex items-center justify-center w-12 h-12 rounded-full dark:bg-violet-400">
                <img
                  className="flex-shrink-0 w-14 h-14 rounded-full dark:text-gray-900"
                  src={logo}
                  alt=""
                />
              </div>
          ...
          <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
            <div className="space-y-3">
              <h3 className="uppercase font-bold font-quicksand text-lg">
                Product
              </h3>
            ...
            <div className="space-y-3">
              <div className="uppercase  font-bold font-quicksand text-lg">
                Social media
              </div>
